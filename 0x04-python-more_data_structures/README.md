...
12. **11-multiply_list_map.py** - `Python` function that returns a list with all values multiplied by a number without using any loops but `map`.
13. **100-weight_average.py** - `Python` function that returns the weighted average of all integers tuple (`score`, `weight`).
14. **102-complex_delete.py** - `Python` function that deletes keys with a specific value in a dictionary.
